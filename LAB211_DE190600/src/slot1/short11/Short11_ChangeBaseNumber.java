...
public class Short11_ChangeBaseNumber {
    ...
    public  long toDecimal(String inputNumber, int base) {
        return Long.parseLong(inputNumber, base);
    }

 
    public  String fromDecimal(long decimalNumber, int targetBase) {
        if (targetBase == 2) {
    ...
    public  boolean validateNumber(String inputNumber, int base) {
